...
export const envSchema = z.object({
  ...
  CANDLE_INTERVAL: z.string().default("1h"),
  ...
  SIGNAL_BUY_THRESHOLD: z.coerce.number().min(0).max(1).default(0.72),
  SIGNAL_SELL_THRESHOLD: z.coerce.number().min(0).max(1).default(0.3),
  DEFAULT_STOP_LOSS_PCT: z.coerce.number().positive().default(1),
  DEFAULT_TAKE_PROFIT_PCT: z.coerce.number().positive().default(2),
  MAX_RISK_PER_TRADE: z.coerce.number().positive().default(0.25),
  ...
  PAPER_ORDER_QUANTITY: z.coerce.number().positive().default(0.001),
